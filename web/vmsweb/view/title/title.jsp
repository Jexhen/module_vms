...
<!-- 表格 -->
<table id="titleTable" lay-filter="titleTable"></table>
<!-- 工具条 -->
...
<script type="text/javascript">
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#titleTable'
            ,height: 500
            ,url: '${pageContext.request.contextPath}/title/getTitles.shtml' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {checkbox: true, fixed: true}
                ,{field: 'mvttId', title: '功能ID', width:80, sort: true, fixed: 'left'}
                ,{field: 'mvttName', title: '功能名称', width:150}
                ,{field: 'mvttUrl', title: '功能URL', width:150}
                ,{field: 'mvttName', title: '功能名称', width:150}
                ,{field: 'mvttUrl', title: '功能URL', width:150}
